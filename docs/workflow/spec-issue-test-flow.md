...
- 对应 Spec 场景
- 执行仓库（blog-FE / blog-BE / blog-Docs）
- 依赖关系（哪些 task 必须先完成）
- 验收标准
...
|-----------------|-----------------|
| blog-BE | blog-BE 仓库的 GitHub Issue |
| blog-FE | blog-FE 仓库的 GitHub Issue |
| blog-Docs | blog-Docs 仓库的 GitHub Issue |
